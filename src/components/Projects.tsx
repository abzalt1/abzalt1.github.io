            ...
            <div className="md:col-span-8 p-0 flex flex-col">
                {image ? (
                    <>
                        ...
                        <div className="p-6 md:p-10 flex flex-col md:flex-row gap-6 justify-between items-start">
...
export default function Projects({ onOpenLightbox }: { onOpenLightbox: (src: string) => void }) {
    ...
    return (
        <section id="projects" className="grid grid-cols-1 gap-8 mb-8 scroll-mt-8">
